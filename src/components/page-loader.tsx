    ...
    <AnimatePresence>
      ...
      >
        ...
        <div className="flex flex-col items-center space-y-8 relative z-10">
          ...
          >
            <motion.div 
              className="w-24 h-24 rounded-full bg-gradient-to-br from-primary to-accent flex items-center justify-center relative overflow-hidden"
              animate={{
                boxShadow: [
            ...
            >
              <motion.span
                className="text-3xl font-bold text-primary-foreground relative z-10"
          ...
          <div className="w-80 h-2 bg-muted/50 rounded-full overflow-hidden border border-primary/20">
            <motion.div
