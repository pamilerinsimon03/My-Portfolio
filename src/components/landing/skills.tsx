    ...
    <section id="skills" className="w-full py-12 md:py-24 lg:py-32 bg-background">
      <div className="container px-4 md:px-6">
        <div className="text-center space-y-2 mb-12">
          <h2 className="text-3xl font-headline font-bold tracking-tighter sm:text-5xl">My Skillset</h2>
                 ...
                 <Card key={category.title}>
                    ...
                    <CardContent className="grid grid-cols-2 gap-4">
                        {category.skills.map(skill => (
                            <div key={skill.name} className="flex items-center gap-4 p-2 rounded-lg hover:bg-accent/20 transition-colors">
                                {skill.icon}
